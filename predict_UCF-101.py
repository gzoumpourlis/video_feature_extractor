...
def main():
    ...
    # ---------------------------------------------------------------------------------------------------------------- #
    parser.add_argument('--videos_root_local', type=str, default='/home/george/datasets/UCF-101', help="set videos root path")
    parser.add_argument('--videos_root_remote', type=str, default='/shared/datasets/UCF-101', help="set videos root path")
    parser.add_argument('--remote', action='store_true')
    parser.add_argument('--c3d_model_root', type=str, default='model', help="set C3D model root path")
    parser.add_argument('--video_list', type=str, default='video_UCF-101.list', help="set video list path")
    parser.add_argument('--preds_c3d_root', type=str, default='preds_c3d_UCF-101', help="set video C3D predictions path, to store .npy files")
    parser.add_argument('--preds_cnn_root', type=str, default='preds_cnn_UCF-101', help="set video CNN predictions path, to store .npy files")
